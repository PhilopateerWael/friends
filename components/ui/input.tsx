...
function Input({
  ...
  return (
    <InputPrimitive
      ...
      className={cn(
        "bg-input dark:bg-input/80 data-[variant=secondary]:bg-default/80 dark:data-[variant=secondary]:bg-default/80 data-[variant=secondary]:shadow-none px-2.5 py-1.5 md:px-3 md:py-2 outline-none shadow-xs rounded-xl transition-colors text-sm w-full min-w-0 placeholder:text-muted-foreground disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50",
